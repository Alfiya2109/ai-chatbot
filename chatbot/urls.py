...
urlpatterns = [
    ...
    path('chatlogs/<int:chatlog_id>/update-answer/', UpdateChatLogAnswerAPIView.as_view(), name='update_chatlog_answer'),
    path('chatlogs/<int:chatlog_id>/mark-correct/', MarkChatLogCorrectAPIView.as_view(), name='mark_chatlog_correct'),
